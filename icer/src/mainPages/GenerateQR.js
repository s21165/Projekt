...
import {handleImageChange} from "./products/handleImageChange";
import {handleQRChange} from "./products/handleQRChange";
            ...
            <div className="productContainerDiv">
                ...
                <form onSubmit={handleSubmit} className="addProductForm">
                    ...
                    <label className="dataLabel">
                        <h5>Data ważności:</h5>
                        <input type="date" name="data_waznosci" className="dataInput" value={formData.data_waznosci}
